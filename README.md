...
**Resposta:** Sim, existe diferença. Os jogos pagos apresentam uma taxa de aprovação de **87,74%**, enquanto os jogos gratuitos ficam em **80,93%** - uma diferença de aproximadamente 7 pontos percentuais. Os jogos pagos também dominam numericamente o catálogo (73.480 títulos vs. 8.290 gratuitos). A menor aceitação dos jogos gratuitos pode estar associada à maior exposição a títulos de baixa qualidade (barreira de entrada menor), enquanto os jogos pagos tendem a passar por maior escrutínio dos consumidores antes da compra.
...
**Resposta:** Os gêneros com as maiores taxas de aprovação são Indie (89,74%), Casual (88,93%), Simulation (88,60%), Adventure (87,51%) e Strategy (87,42%), com preços médios na faixa de **US$ 7 a US$ 11**. Gêneros como RPG (87,38%, US$ 11,17) e Action (87,25%, US$ 9,44) também aparecem próximos. Os gêneros com menor aceitação - Sexual Content (78,99%), Gore (75,67%) e Nudity (70,75%) - têm preços médios ainda menores (US$ 5 a US$ 6). No geral, os gêneros mais bem avaliados concentram-se na faixa de preço acessível, indicando que na Steam a aprovação não está ligada a preços mais altos.
...
**Resposta:** O volume de lançamentos cresceu de forma expressiva e contínua de 2012 (317 títulos) até 2024 (12.199 títulos), representando um aumento de aproximadamente **38x** no período. Observam-se três fases: (1) crescimento inicial moderado (2012–2015), (2) aceleração (2015–2018, impulsionada por ferramentas de publicação acessíveis), e (3) maturação em patamar elevado (2018–2024). A queda em 2026 reflete dados parciais (ano não completo). A proporção de jogos gratuitos cresceu até 2020 (~17%), mas voltou a cair nos anos mais recentes (~6% em 2024), indicando que o modelo pago permanece dominante.
...
**Resposta:** Há uma relação clara e positiva entre a quantidade de conquistas e praticamente todos os indicadores de engajamento. Jogos sem conquistas têm uma quantidade média de horas jogadas de 58 minutos e taxa de aprovação de 71,2%. À medida que o número de achievements aumenta, a quantidade média de horas jogadas cresce de forma escalonada, atingindo **819 minutos** na faixa de 100+ conquistas. As recomendações médias passam de 778 (sem conquistas) para mais de 20.600 (100+), e o total de avaliações salta de 882 para 23.379. A taxa de aprovação também melhora, passando de 71% para ~81% na faixa 51–100, embora recue levemente para 79,7% no grupo 100+ (possivelmente por expectativas mais altas em jogos com muitas conquistas). Isso sugere que as conquistas funcionam como um mecanismo efetivo de retenção e fidelização.
...
**Resposta:** A correlação de Pearson entre o número absoluto de conquistas e o total de avaliações é **0,0104**, ou seja, praticamente nula. Embora a tabela por faixas mostre que jogos com mais conquistas tendem a ter mais avaliações em média (de 882 para 23.379), a correlação linear ponto-a-ponto é desprezível. Isso indica que a relação não é linear: o efeito observado nas faixas é provavelmente um reflexo indireto - jogos maiores, com maior produção e maior base de jogadores, tendem a ter tanto mais conquistas quanto mais avaliações, mas o número de conquistas por si só não é um preditor linear do volume de avaliações.
...
**Resposta:** Os títulos com maior tempo médio de jogo são predominantemente jogos de nicho (visual novels asiáticos, idle games e simuladores). O primeiro colocado, *Letters From a Rainy Day*, apresenta uma média de quase **360 horas** de jogo. O top 20 inclui também títulos como *Wizard And Minion Idle* (171 min), *Franchise Hockey Manager 9* (152 min) e *NGU IDLE* (57 min), todos com altíssima quantidade média de horas jogadas. A maioria dos títulos é paga, com taxas de aprovação variadas (45% a 98%).
...
**Resposta:** As maiores médias de horas jogadas por usuário concentram-se em **Massively Multiplayer** (328 min), **RPG** (245 min) e **Free To Play** (224 min) - gêneros que naturalmente favorecem sessões longas e replayabilidade. Sports (213 min) e Simulation (204 min) também aparecem com destaque. Gêneros casuais e de alta rotatividade como Indie (79 min) e Action (63 min) ficam nas últimas posições.
...
Quanto ao engajamento, os dados mostram uma relação robusta entre conquistas (achievements) e métricas de retenção: jogos com mais conquistas têm a quantidade média de horas jogadas maior, mais recomendações e mais avaliações. No entanto, a correlação linear entre o número absoluto de conquistas e o total de avaliações é praticamente nula (Pearson = 0,01), o que indica que o efeito não é direto - conquistas são um proxy para jogos maiores e mais produzidos, não uma causa linear isolada.

Os gêneros com maior quantidade de horas jogadas são Massively Multiplayer, RPG e Free To Play, confirmando a expectativa de que jogos com progressão contínua e multiplayer engajam por mais tempo.
